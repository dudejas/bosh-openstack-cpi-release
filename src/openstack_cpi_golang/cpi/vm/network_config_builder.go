...
func NewNetworkConfigBuilder(networkService services.NetworkService, networks apiv1.Networks, openstackConfig config.OpenstackConfig, cloudProps properties.CreateVM) networkConfigBuilder {
